 ...
 *    }
 *}
 * </pre> The call to {@code show} in this example creates a JFrame (named
 ...
 *     }
 * }
 * </pre> The ResourceBundle should contain definitions for all of the standard
 ...
 * </pre>
 */
public abstract class JAudioSingleFrameApp extends Application {

    private static final Logger logger = Logger.getLogger(JAudioSingleFrameApp.class.getName());
